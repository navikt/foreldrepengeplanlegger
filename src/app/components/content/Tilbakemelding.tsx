...
const Tilbakemelding: React.StatelessComponent<Props> = (props) => (
	<div className="tilbakemelding">
		...
		<p>
			Takk for at du tester ut vår nye foreldrepengeplanlegger her på NAV LAB.
			Vi vil gjerne vite hva du syns om planleggeren, så vi har laget et lite
			spørreskjema med fire spørsmål som vi ønsker at du svarer på.
		</p>
		<Lenke
