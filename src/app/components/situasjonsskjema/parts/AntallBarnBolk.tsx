...
import { Søkersituasjon } from '../../../types';
import getMessage from 'common/utils/i18nUtils';
import Labeltekst from 'common/components/skjema/labeltekst/Labeltekst';
...
class AntallBarnBolk extends React.Component<Props> {
    ...
    render() {
        const { spørsmål, inputName, antallBarn, intl, erBarnetFødt, situasjon } = this.props;
            ...
            <React.Fragment>
                <Block>
                    <RadioGroup
                        legend={spørsmål}
                        name={inputName}
                        onChange={(value) => this.onRadioChange(value as AntallBarnVerdi)}
