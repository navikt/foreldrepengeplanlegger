...
const UtsettelseDialog: React.StatelessComponent<Props> = (props: Props) => {
	return (
		<div>
			<LeggTilKnapp onClick={() => props.dispatch(ubetaltPermisjonVisDialog())}>
			...
			<Modal
				...
				children={
					<div className="dialogContent">
						...
						<p>
							Ønsker dere å ha opphold i foreldrepengene med ulønnet permisjon
							må den andre forelderen søke om utsettelse.
						</p>
					</div>
				}
			/>
