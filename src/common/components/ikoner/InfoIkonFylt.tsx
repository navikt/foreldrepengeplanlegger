...
const InfoIkonFylt = (props: any) => (
    <svg role="presentation" focusable="false" height="1.5rem" width="1.5rem" viewBox="0 0 24 24" {...props}>
        <g fill="none" fillRule="evenodd">
            <path
                ...
                fillRule="nonzero"
            />
            <path d="M12.027 19H12a1.499 1.499 0 0 1-.027-3H12a1.501 1.501 0 0 1 .027 3z" fill="#3E3832" />
            <path d="M12 5a1 1 0 0 1 1 1v7a1 1 0 0 1-2 0V6a1 1 0 0 1 1-1z" fill="#3E3832" fillRule="nonzero" />
        </g>
    </svg>
);
export default InfoIkonFylt;
